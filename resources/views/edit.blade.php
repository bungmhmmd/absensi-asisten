...
<div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow">
                    ...
                    <h2 class="text-center">Edit Data Asisten</h2>                                                                    
                        <br/>
                        <br/>                        
                        @foreach($users as $u)
                        <form action="/daftar-asisten/update" method="post">
                        {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="type" value="{{ $u->type }}">
                                    <option>-</option>
                                    <option>admin</option>
                            ...
                            <a class="btn btn-outline-warning" href="/daftar-asisten"> Kembali</a>
                            </div>
                        </form>
                        @endforeach
                        </div>        
